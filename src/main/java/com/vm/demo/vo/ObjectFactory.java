 ...
 * generated in the com.vm.demo.vo package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetCustomersByName_QNAME = new QName("http://vo.demo.vm.com/", "getCustomersByName");
    private final static QName _UpdateCustomer_QNAME = new QName("http://vo.demo.vm.com/", "updateCustomer");
    private final static QName _UpdateCustomerResponse_QNAME = new QName("http://vo.demo.vm.com/", "updateCustomerResponse");
    private final static QName _GetCustomersByNameResponse_QNAME = new QName("http://vo.demo.vm.com/", "getCustomersByNameResponse");
    private final static QName _NoSuchCustomer_QNAME = new QName("http://vo.demo.vm.com/", "NoSuchCustomer");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.vm.demo.vo
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://vo.demo.vm.com/", name = "getCustomersByName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://vo.demo.vm.com/", name = "updateCustomer")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://vo.demo.vm.com/", name = "updateCustomerResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://vo.demo.vm.com/", name = "getCustomersByNameResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://vo.demo.vm.com/", name = "NoSuchCustomer")
